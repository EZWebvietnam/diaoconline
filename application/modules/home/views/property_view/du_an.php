<div class="col_600 margin_left">
                <div id="result" class="margin_bottom">
                    ...
                    <div class="rounded_style_2 rounded_box"><div class="TL"></div><div class="TR"></div><div class="BL"></div><div class="BR"></div>
                        <div class="content">
                            <p>
                            </p><h1 class="title"><?php if(isset($list[0])){echo $list[0]['name_project'];} else { echo "Dự án";}?></h1>
...
<script type="text/javascript">
    $(function () {
        $('.pager').html(LoadPagging(<?php echo $page;?>, <?php echo $total?>, '<?php echo base_url();?>sieu-thi/du-an.'.$id.'.duan',<?php echo $total_page?>));
    });
</script>

...
<script type="text/javascript">
    $(function () {
        $('.pager').html(LoadPagging(<?php echo $page;?>, <?php echo $total?>, '<?php echo base_url();?>sieu-thi/chinh-chu',<?php echo $total_page?>));
    });
</script>
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="right margin_left">
                                                    <div class="content">
                                                        ...
                                                        <div class="price">
                                                            <p>Giá cho thuê:<br><strong><?php if(is_numeric($list_property['price']))
                                                            {
...
<script type="text/javascript">
    $(function () {
        $('.pager').html(LoadPagging(<?php echo $page;?>, <?php echo $total?>, '<?php echo base_url();?>sieu-thi',<?php echo $total_page?>));
    });
</script>

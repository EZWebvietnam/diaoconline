              ...
              <div id="propertise_displaying" class="box">
              	...
              	<div class="headline_11">
                    ...
                    <div class="headline_title_1">
                        ...
                        <h2>TÀI SẢN HẾT HẠN (<span class="ItemTotal"><?php echo $total;?></span>)
                    	...
                    	<ul>
                            ...
                            <?php } ?>
                                ...
                                <div class="repair_post">
                                        ...
                                        <a href="<?php echo base_url();?>thanh-vien/gia-han-dich-vu/<?php echo $item['id']?>" class="repair"><span class="ico_16 ico_repair_16"></span>Gia hạn</a>

                        ...
                        <div class="body">
                           	  ...
                           	  <fieldset>
                           	    ...
                           	    <ul>
                                    ...
                                    <li>Số tiền: <div id="price_">0</div></li>

                                    <li>Thời gian: <input name="time" type="text" id="month" size="1" value=""/> tháng</li>

                                    <li>Đến ngày: <div id="date"></div></li>

                                    <li>Tổng tiền: <div id="money_s"></div></li>

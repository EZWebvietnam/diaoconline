              ...
              <div id="propertise_displaying" class="box">
              	...
              	<div class="headline_11">
                    ...
                    <div class="headline_title_1">
                        ...
                        <h2>TÀI SẢN ĐANG SOẠN (<span class="ItemTotal"><?php echo $total;?></span>)
                            ...
                            <?php } ?>
                             	...
                             	<div class="short_info">
                                    ...
                                    <span class="property_code">MSTS:<strong><?php echo $item['code']?></strong></span><br/>
                                        ...
                                        <span class="location">Vị trí: <?php if($item['id_district'] =='' || $item['id_district']==0){ echo 'Đang cập nhập';} else { echo $list_district[$item['id_district']]; }?>, <?php if($item['id_city'] =='' || $item['id_city']==0) {echo 'Đang cập nhập';} else { echo $list_city[$item['id_city']];}?></span>

<div class="NavContent">Đang duyệt:<span class="NavLink"><a href="/">Trang chủ</a></span><span class="NavLink"><?php echo $content[0]['name']?></span></div>
<div class="box-head"><?php echo $content[0]['name']?></div>
<div class="box-body"><p><?php echo $content[0]['content']?></p>
                        </div>

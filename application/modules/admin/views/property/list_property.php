            ...
            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="center"><?php if($prj['id_district']=='' || $prj['id_district']==0){ echo 'Chưa cập nhập';} else {echo $list_district[$prj['id_district']];}?>,<?php if($prj['id_city']=='' || $prj['id_city'] ==0){ echo 'Chưa cập nhập';} else { echo $list_city[$prj['id_city']];}?></td>

...
class Userlist extends CI_Controller {
    ...
    public function view($id = null) {
        ...
        if (empty($id)) {
            redirect('admin/userlist/listuser');
        } else {
            ...
            if (empty($user_info)) {
                ...
                $this->load->view('admin/layout_profile', $data);
            }
        }
    }
    ...
    function test_send_mail($email, $username, $password) {
        $mail_body = "Xin chào bạn <br/> Bạn nhận được email này vì bạn đã được đăng ký tài khoản tại hệ thống admin của HUTECH DEVELOPERS CLUB.<br/> Username của bạn là:" . $email . "<br/> Password:" . $password;

...
<head>
    ...
    <title>Các dự án địa ốc, bất động sản, khu công nghiệp, khu du lịch nghỉ dưỡng - DiaOcOnline</title>
                        ...
                        <div class="active_tool_1">
                            <ul>
                                ...
                                <li class="last"><span class="ico_16 ico_trade_16"></span>
                                    <a href="<?php echo base_url();?>sieu-thi/loc/?duan=<?php echo $proj_l['id_pro']?>">Tài sản đang giao dịch</a></li>
                            </ul>
                        </div>
                    </div> 
              <?php $i++;} ?>      

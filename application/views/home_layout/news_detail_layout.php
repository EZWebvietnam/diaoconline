    ...
    <script type="text/javascript">
        ...
        <div id="head_content" class="wrap">
                                        ...
                                        <div class="content_inner rounded_style_7 rounded_box">
                                                <div class="content">
                                                    ...
                                                    <div class="right">
                                                        ...
                                                        <span class="updated_date">1 giờ 36 ph&#250;t trước</span>
                                                        <br />
            ...
            <div class="post_propertise">
                <a href="/thanh-vien/tai-san-dang-moi/45146">ĐĂNG TÀI SẢN CỦA BẠN</a>
            </div>
        </div>
    </div>
...
<div class="margin_bottom" style="clear:both;display:table;">
    <div class="headline_title_1 rounded_style_5 rounded_box">
        ...
        <div class="BL"></div>
        <div class="BR"></div>
        <h2 class="headline"><a href="/tin-tuc-c/<?php echo mb_strtolower(url_title(removesign($menu_left['cate_parent']['name']))); ?>-c<?php echo $menu_left['cate_parent']['id'] ?>"><span><?php echo $menu_left['cate_parent']['name']?></span></a></h2>
    </div>
    ...
    <ul>
            ...
            {
            ?>
            <li id="c_<?php echo $k?>" ><a href="/tin-tuc-c/<?php echo mb_strtolower(url_title(removesign($cate_sub)));?>-c<?php echo $k?>"><?php echo $cate_sub?></a></li>
            <?php } ?>
    </ul>
    </div>
</div>
